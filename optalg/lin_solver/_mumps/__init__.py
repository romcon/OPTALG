"""
- Removed MPI (Tomas Tinoco De Rubira, 04/03/2015)
- Commented out "undestroyed warning", destroy() is called anyway (Tomas Tinoco De Rubira, 06/01/2015)
"""
...
class _MumpsBaseContext(object):
    ...
    def __init__(self, par=1, sym=0, comm=None):
        ...
        self.id.par = par
        self.id.sym = sym
        self.id.comm_fortran = 0 #comm.py2f()
        self.run(job = -1) # JOB_INIT
        self.myid = 0 #comm.rank
